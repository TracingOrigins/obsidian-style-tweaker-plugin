...
export type ColorfulFolderPalette = "one" | "two" | "three" | "four" | "five" | "six" | "custom";
...
export interface StyleTweakerSettings {
    ...
    desktopNewTabParticleMotion:
        "none" | "float" | "undulate" | "wave" | "ripple" | "heartbeat" | "breathe"; // 粒子律动：静止/整体浮动/错落浮动/波浪/涟漪/心跳/呼吸
    //  交互
    ...
    mobileNewTabParticleMotion:
        "none" | "float" | "undulate" | "wave" | "ripple" | "heartbeat" | "breathe";
