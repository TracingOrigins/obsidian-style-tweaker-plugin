...
export const LINK_STYLES_CSS = css`
    /* ============================================================
       0. 变量收敛
    ...
    body.style-tweaker-link-underline-internal
        .markdown-source-view.mod-cm6
        .cm-hmd-internal-link
    ...
    body.style-tweaker-link-underline-unresolved
        :is(.markdown-preview-view, .markdown-rendered)
    ...
    /* 彩色内部/外部链接悬浮动画（阅读模式） */
    body.style-tweaker-link-colorful-animation
        :is(.markdown-preview-view, .markdown-rendered)
        .internal-link:hover,
    body.style-tweaker-link-colorful-animation
        :is(.markdown-preview-view, .markdown-rendered)
