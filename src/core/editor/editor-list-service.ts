...
export class EditorListService extends BaseService {
    ...
    protected applyToDocument(doc: Document): void {
        ...
        setAccentVar(
            doc,
            s.listUlActiveIndentColor,
            LIST_UL_ACTIVE_COLOR_VAR,
            "var(--style-tweaker-list-ul-indent-color)",
        );
        setAccentVar(
            doc,
            s.listOlActiveIndentColor,
            LIST_OL_ACTIVE_COLOR_VAR,
            "var(--style-tweaker-list-ol-indent-color)",
        );
        setAccentVar(doc, s.taskIndentColor, TASK_INDENT_COLOR_VAR, "var(--color-accent)");
        setAccentVar(
            doc,
            s.taskActiveIndentColor,
            TASK_ACTIVE_COLOR_VAR,
            "var(--style-tweaker-task-indent-color)",
        );
