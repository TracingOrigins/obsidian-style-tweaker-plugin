...
export class LeftRightSpaceService extends BaseService {
    ...
    private locateSide(rootSplit: HTMLElement, side: Side): void {
        ...
        const start = side === "left" ? children[1] : children[children.length - 1];
        if (!start) return;
    ...
    private dispatchAfterVertical(el: HTMLElement, side: Side, tabs: HTMLElement[]): void {
    ...
    private loopHorizontal(horizontal: HTMLElement, side: Side, tabs: HTMLElement[]): void {
