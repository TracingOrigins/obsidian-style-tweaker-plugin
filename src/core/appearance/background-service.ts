...
export type WallpaperKey = "desktopDark" | "desktopLight" | "mobileDark" | "mobileLight";
...
export class BackgroundService extends BaseService {
    ...
    private getWallpaperImages(s: StyleTweakerSettings, key: WallpaperKey): TFile[] {
    ...
    private normalizeIndex(s: StyleTweakerSettings, key: WallpaperKey, length: number): number {
    ...
    private getFolder(s: StyleTweakerSettings, key: WallpaperKey): string {
        switch (key) {
            case "desktopDark":
                return s.desktopWallpaperFolderDark;
            case "desktopLight":
                return s.desktopWallpaperFolderLight;
            case "mobileDark":
                return s.mobileWallpaperFolderDark;
            case "mobileLight":
                return s.mobileWallpaperFolderLight;
        }
    }
    ...
    private getMode(s: StyleTweakerSettings, key: WallpaperKey): WallpaperMode {
        switch (key) {
            case "desktopDark":
                return s.desktopWallpaperModeDark;
            case "desktopLight":
                return s.desktopWallpaperModeLight;
            case "mobileDark":
                return s.mobileWallpaperModeDark;
            case "mobileLight":
                return s.mobileWallpaperModeLight;
        }
    }
    ...
    private getInterval(s: StyleTweakerSettings, key: WallpaperKey): number {
        const v = (() => {
            switch (key) {
                case "desktopDark":
                    return s.desktopWallpaperIntervalDark;
                case "desktopLight":
                    return s.desktopWallpaperIntervalLight;
                case "mobileDark":
                    return s.mobileWallpaperIntervalDark;
                case "mobileLight":
                    return s.mobileWallpaperIntervalLight;
            }
        })();
    ...
    private getIndex(s: StyleTweakerSettings, key: WallpaperKey): number {
        switch (key) {
            case "desktopDark":
                return s.desktopWallpaperIndexDark;
            case "desktopLight":
                return s.desktopWallpaperIndexLight;
            case "mobileDark":
                return s.mobileWallpaperIndexDark;
            case "mobileLight":
                return s.mobileWallpaperIndexLight;
        }
    }
    ...
    private setIndex(s: StyleTweakerSettings, key: WallpaperKey, idx: number): void {
        switch (key) {
            case "desktopDark":
                s.desktopWallpaperIndexDark = idx;
                break;
            case "desktopLight":
                s.desktopWallpaperIndexLight = idx;
                break;
            case "mobileDark":
                s.mobileWallpaperIndexDark = idx;
                break;
            case "mobileLight":
                s.mobileWallpaperIndexLight = idx;
                break;
        }
    }
    ...
    private applyClassesToDoc(doc: Document): void {
        ...
        const imageOn = active && s.backgroundType === "image" && this.hasResolvedImage(s);
        // 纯色类：激活 且 纯色模式
