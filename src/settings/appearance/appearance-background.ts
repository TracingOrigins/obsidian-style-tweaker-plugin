    ...
    return {
        ...
        items: [
            ...
            },
            {
                ...
                control: {
                    type: "dropdown",
                    key: "solidLightFlavor",
                    options: getLightFlavorOptions(),
                },
            },
            {
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                visible: () =>
                                    plugin.settings.desktopWallpaperModeDark === "manual",
                                control: {
                                    type: "file",
                            ...
                            {
                                name: t("appearance.background.image.glassTint"),
                                desc: t("appearance.background.image.glassTint.desc"),
                                control: {
                                    type: "slider",
                                    key: "desktopGlassTintDark",
                                    min: 0,
                                    max: 100,
                                    step: 1,
                                    unit: "%",
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                desc: t("appearance.background.image.manualImage.desc"),
                                visible: () =>
                                    plugin.settings.desktopWallpaperModeLight === "manual",
                                control: {
                                    type: "file",
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                desc: t("appearance.background.image.manualImage.desc"),
                                visible: () =>
                                    plugin.settings.mobileWallpaperModeLight === "manual",
                                control: {
                                    type: "file",
