                                ...
                                items: [
                                    {
                                        ...
                                        control: {
                                            type: "toggle",
                                            key: "feColorfulFoldersEnabled",
                                        },
                                    },
                                    {
                                        type: "group",
                                        heading: t(
                                            "plugins.fileExplorer.coloredFolders.group.dark",
                                        ),
                                        items: [
                                            {
                                                name: t("plugins.fileExplorer.coloredFolders.mode"),
                                                desc: t(
                                                    "plugins.fileExplorer.coloredFolders.mode.desc",
                                                ),
                                                visible: () =>
                                                ...
                                                control: {
                                                    ...
                                                    options: {
                                                        background: t(
                                                            "plugins.fileExplorer.coloredFolders.mode.background",
                                                        ),
                                                        title: t(
                                                            "plugins.fileExplorer.coloredFolders.mode.title",
                                                        ),
                                                        border: t(
                                                            "plugins.fileExplorer.coloredFolders.mode.border",
                                                        ),
                                                        tab: t(
                                                            "plugins.fileExplorer.coloredFolders.mode.tab",
                                                        ),
                                                    },
                                                },
                                            },
                                            {
                                                name: t(
                                                    "plugins.fileExplorer.coloredFolders.palette",
                                                ),
                                                desc: t(
                                                    "plugins.fileExplorer.coloredFolders.palette.desc",
                                                ),
                                                visible: () =>
                                                    plugin.settings.feColorfulFoldersEnabled,
                                                control: {
                                                    ...
                                                    options: {
                                                        one: t(
                                                            "plugins.fileExplorer.coloredFolders.palette.one",
                                                        ),
                                                        two: t(
                                                            "plugins.fileExplorer.coloredFolders.palette.two",
                                                        ),
                                                        three: t(
                                                            "plugins.fileExplorer.coloredFolders.palette.three",
                                                        ),
                                                        four: t(
                                                            "plugins.fileExplorer.coloredFolders.palette.four",
                                                        ),
                                                        five: t(
                                                            "plugins.fileExplorer.coloredFolders.palette.five",
                                                        ),
                                                        six: t(
                                                            "plugins.fileExplorer.coloredFolders.palette.six",
                                                        ),
                                                        custom: t(
                                                            "plugins.fileExplorer.coloredFolders.palette.custom",
                                                        ),
                                                    },
                                                },
                                            },
                                            {
                                                ...
                                                visible: () =>
                                                    plugin.settings.feColorfulFoldersEnabled &&
                                                    plugin.settings.feColorfulFolderPaletteDark ===
                                                        "custom",
                                                control: {
                                                    type: "dropdown",
                                                    key: "feColorfulFolderColorDark",
                                                    options: getAccentColorOptions(),
                                                },
                                            },
                                            {
                                                name: t(
                                                    "plugins.fileExplorer.removeFirstLevelFolderIcon",
                                                ),
                                                desc: t(
                                                    "plugins.fileExplorer.removeFirstLevelFolderIcon.desc",
                                                ),
                                                visible: () => {
                                                ...
                                                control: {
                                                    type: "toggle",
                                                    key: "feRemoveFirstLevelFolderIconDark",
                                                },
                                            },
                                        ],
                                    },
                                    {
                                        type: "group",
                                        heading: t(
                                            "plugins.fileExplorer.coloredFolders.group.light",
                                        ),
                                        items: [
                                            {
                                                name: t("plugins.fileExplorer.coloredFolders.mode"),
                                            ...
                                            },
                                            {
                                                ...
                                                visible: () =>
                                                    plugin.settings.feColorfulFoldersEnabled &&
                                                    plugin.settings.feColorfulFolderPaletteLight ===
                                                        "custom",
                                                control: {
                                                    type: "dropdown",
                                                    key: "feColorfulFolderColorLight",
                                                    options: getAccentColorOptions(),
                                                },
                                            },
                                            {
                                                ...
                                                control: {
                                                    type: "toggle",
                                                    key: "feRemoveFirstLevelFolderIconLight",
                                                },
                                            },
                                        ],
                                    },
